...
import io.vizend.studyflow.storejpa.todolist.cm.optionstore.repository.ToDoListJpaOptionRepository;
...
public class ToDoListJpaOptionStore implements ToDoListOptionStore {
    /* Gen by Vizend Vista v7.0.0 */
    private final ToDoListJpaOptionRepository toDoListJpaOptionRepository;
