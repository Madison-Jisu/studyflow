...
import io.vizend.studyflow.storejpa.todolist.cm.optionstore.repository.TaskJpaOptionRepository;
...
public class TaskJpaOptionStore implements TaskOptionStore {
    /* Gen by Vizend Vista v7.0.0 */
    private final TaskJpaOptionRepository taskJpaOptionRepository;
